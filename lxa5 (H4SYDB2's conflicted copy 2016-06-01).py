...
print
"Total words:", len(Lexicon.WordList)
print
"Total letter count in words: ", totalLetterCountInWords, "or ", str(
    totalLetterCountInWords / 1000) + "K", "average letters per word: ", totalLetterCountInWords / len(Lexicon.WordList)
...
if True:
    ...
    print
    "Letter cost of stems: ", str(letterCostOfStems / 1000) + "K."
    print
    "Letter cost of signatures: ", str(letterCostOfSignatures / 1000) + "K."
    print
    "Letter cost of stems + signatures: ", str((letterCostOfStems + letterCostOfSignatures) / 1000) + "K."
    print
    "Number of signatures: ", len(Lexicon.SignatureToStems)
...
print >> logfile, outfile_Signatures_name.ljust(60), '%30s wordcount: %8d data source:' % (
